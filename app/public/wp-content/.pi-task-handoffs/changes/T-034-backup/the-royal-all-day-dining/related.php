...
?>
<section class="pp__section pp__section--alt pp-related-trd">
  <div class="pp__container pp-container-shared">
    ...
    <figure class="pp-image-container-shared">
      <img src="<?php echo sgh_img('the-royal-all-day-dining/the-royal-all-day-dining-he-thong-quay-so-che-rua-sach.jpg'); ?>" alt="<?php echo esc_attr__('Hệ thống quầy sơ chế chậu rửa và lưu trữ lạnh bằng inox 304 chuẩn công nghiệp', 'saigonhoreca'); ?>" loading="lazy" decoding="async" width="1366" height="768">
    </figure>
    <div class="pp-text-trd pp-text-trd--narrow">
      <div class="pp-text-trd__body">
