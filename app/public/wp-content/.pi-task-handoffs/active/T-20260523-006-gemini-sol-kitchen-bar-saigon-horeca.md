...
# 📋 T-20260523-006 | gemini | sol-kitchen-bar-saigon-horeca — Hồ Sơ Thiết Kế Độc Bản / Bespoke Task Specification
...
|---|---|---|
| `id` | `T-20260523-006` | 🆔 Định danh duy nhất của task con. |
...
Mục tiêu tối thượng là nâng cấp visual cho dự án **Sol Kitchen & Bar Corporate Spec** thoát khỏi sự rập khuôn phẳng lì Elementor cũ, mang lại trải nghiệm thị giác độc bản theo đúng nhóm thiết kế nghệ thuật **Cyberpunk Neon Glow (Corporate Latin Glow)**.

### 🌟 Ý tưởng độc bản:
- **Định vị cốt lõi**: Earthy Neon Split - Sự kết hợp táo bạo giữa màu nâu đất nung và dải viền neon màu cam rực cháy. Bố cục hai cột lệch đối xứng tạo độ sâu thị giác khi cuộn trang, card CTA ôm khít quầy bar rượu rum hoang dã sang trọng.
- **Intro & Concept**: Intro giới thiệu quy mô hợp tác dự án thông qua layout Split Panel màu đất nung. Concept sử dụng các card thông tin có viền sáng mượt mà.
...
- 📄 `template-parts/project-pillar/sol-kitchen-bar-saigon-horeca/concept.php`
- 📄 `template-parts/project-pillar/sol-kitchen-bar-saigon-horeca/cta.php`
- 📄 `template-parts/project-pillar/sol-kitchen-bar-saigon-horeca/gallery.php`
- 📄 `template-parts/project-pillar/sol-kitchen-bar-saigon-horeca/hero.php`
- 📄 `template-parts/project-pillar/sol-kitchen-bar-saigon-horeca/intro.php`
- 📄 `template-parts/project-pillar/sol-kitchen-bar-saigon-horeca/partnership.php`
- 📄 `template-parts/project-pillar/sol-kitchen-bar-saigon-horeca/related.php`
- 📄 `template-parts/project-pillar/sol-kitchen-bar-saigon-horeca/specs.php`
- 📄 `template-parts/project-pillar/sol-kitchen-bar-saigon-horeca/concept.css`
- 📄 `template-parts/project-pillar/sol-kitchen-bar-saigon-horeca/cta.css`
- 📄 `template-parts/project-pillar/sol-kitchen-bar-saigon-horeca/gallery.css`
- 📄 `template-parts/project-pillar/sol-kitchen-bar-saigon-horeca/hero.css`
- 📄 `template-parts/project-pillar/sol-kitchen-bar-saigon-horeca/intro.css`
- 📄 `template-parts/project-pillar/sol-kitchen-bar-saigon-horeca/partnership.css`
- 📄 `template-parts/project-pillar/sol-kitchen-bar-saigon-horeca/related.css`
- 📄 `template-parts/project-pillar/sol-kitchen-bar-saigon-horeca/specs.css`
