...
# 📋 T-20260523-028 | gemini | du-an-kdl-rung-thong-nui-voi-cua-saigonhoreca — Hồ Sơ Thiết Kế Độc Bản / Bespoke Task Specification
...
|---|---|---|
| `id` | `T-20260523-028` | 🆔 Định danh duy nhất của task con. |
...
Mục tiêu tối thượng là nâng cấp visual cho dự án **Bếp KDL Rừng Thông Núi Voi** thoát khỏi sự rập khuôn phẳng lì Elementor cũ, mang lại trải nghiệm thị giác độc bản theo đúng nhóm thiết kế nghệ thuật **Eco-Industrial Spec (Thiên Nhiên & Bền Bỉ)**.

### 🌟 Ý tưởng độc bản:
- **Định vị cốt lõi**: Alpine Timber Grid - Kết cấu khung gỗ thông tự nhiên kết hợp inox bền bỉ ngoài trời. Sử dụng các card thông tin màu xanh lá thông trầm, nền kính mờ trong suốt, các góc bo tròn lớn mang hơi thở thiên nhiên đại ngàn Tây Nguyên hùng vĩ.
- **Intro & Concept**: Intro sử dụng ảnh lớn tràn viền và text màu gỗ ấm. Concept thiết kế dạng các mảng khối gỗ thô chứa văn bản mô tả dự án.
...
- 📄 `template-parts/project-pillar/du-an-kdl-rung-thong-nui-voi-cua-saigonhoreca/cta.php`
- 📄 `template-parts/project-pillar/du-an-kdl-rung-thong-nui-voi-cua-saigonhoreca/gallery.php`
- 📄 `template-parts/project-pillar/du-an-kdl-rung-thong-nui-voi-cua-saigonhoreca/hero.php`
...
- 📄 `template-parts/project-pillar/du-an-kdl-rung-thong-nui-voi-cua-saigonhoreca/related.php`
- 📄 `template-parts/project-pillar/du-an-kdl-rung-thong-nui-voi-cua-saigonhoreca/specs.php`
- 📄 `template-parts/project-pillar/du-an-kdl-rung-thong-nui-voi-cua-saigonhoreca/concept.css`
- 📄 `template-parts/project-pillar/du-an-kdl-rung-thong-nui-voi-cua-saigonhoreca/cta.css`
- 📄 `template-parts/project-pillar/du-an-kdl-rung-thong-nui-voi-cua-saigonhoreca/gallery.css`
- 📄 `template-parts/project-pillar/du-an-kdl-rung-thong-nui-voi-cua-saigonhoreca/hero.css`
- 📄 `template-parts/project-pillar/du-an-kdl-rung-thong-nui-voi-cua-saigonhoreca/intro.css`
- 📄 `template-parts/project-pillar/du-an-kdl-rung-thong-nui-voi-cua-saigonhoreca/partnership.css`
- 📄 `template-parts/project-pillar/du-an-kdl-rung-thong-nui-voi-cua-saigonhoreca/related.css`
- 📄 `template-parts/project-pillar/du-an-kdl-rung-thong-nui-voi-cua-saigonhoreca/specs.css`
