...
# 📋 T-20260523-016 | gemini | g-cup-coffee-bistro — Hồ Sơ Thiết Kế Độc Bản / Bespoke Task Specification
...
|---|---|---|
| `id` | `T-20260523-016` | 🆔 Định danh duy nhất của task con. |
...
Mục tiêu tối thượng là nâng cấp visual cho dự án **G-Cup Coffee Bistro** thoát khỏi sự rập khuôn phẳng lì Elementor cũ, mang lại trải nghiệm thị giác độc bản theo đúng nhóm thiết kế nghệ thuật **European Elegance (Cozy Cafe Bistro)**.

### 🌟 Ý tưởng độc bản:
- **Định vị cốt lõi**: Cozy Glassmorphic Bistro - Tông màu cam đất ấm cúng kết hợp với beige kem ngọt ngào. Các card thông tin có độ mờ trong suốt cực cao giống như một chiếc cốc thủy tinh chứa đầy cà phê sữa đá, khung ảnh kiểu Polaroid lệch góc xếp chồng năng động và trẻ trung.
- **Intro & Concept**: Intro sử dụng layout đan xen giữa ảnh check-in và text giới thiệu viết tay tinh nghịch. Concept sử dụng card bo góc 32px mịn màng.
...
- 📄 `template-parts/project-pillar/g-cup-coffee-bistro/01-hero.php`
- 📄 `template-parts/project-pillar/g-cup-coffee-bistro/02-with_gallery.php`
- 📄 `template-parts/project-pillar/g-cup-coffee-bistro/03-split.php`
- 📄 `template-parts/project-pillar/g-cup-coffee-bistro/04-bg_section.php`
- 📄 `template-parts/project-pillar/g-cup-coffee-bistro/05-with_gallery.php`
- 📄 `template-parts/project-pillar/g-cup-coffee-bistro/06-split.php`
- 📄 `template-parts/project-pillar/g-cup-coffee-bistro/07-text.php`
- 📄 `template-parts/project-pillar/g-cup-coffee-bistro/concept.php`
- 📄 `template-parts/project-pillar/g-cup-coffee-bistro/cta.php`
- 📄 `template-parts/project-pillar/g-cup-coffee-bistro/gallery.php`
- 📄 `template-parts/project-pillar/g-cup-coffee-bistro/hero.php`
- 📄 `template-parts/project-pillar/g-cup-coffee-bistro/intro.php`
- 📄 `template-parts/project-pillar/g-cup-coffee-bistro/partnership.php`
- 📄 `template-parts/project-pillar/g-cup-coffee-bistro/related.php`
- 📄 `template-parts/project-pillar/g-cup-coffee-bistro/specs.php`
- 📄 `template-parts/project-pillar/g-cup-coffee-bistro/concept.css`
- 📄 `template-parts/project-pillar/g-cup-coffee-bistro/cta.css`
- 📄 `template-parts/project-pillar/g-cup-coffee-bistro/gallery.css`
- 📄 `template-parts/project-pillar/g-cup-coffee-bistro/hero.css`
- 📄 `template-parts/project-pillar/g-cup-coffee-bistro/intro.css`
- 📄 `template-parts/project-pillar/g-cup-coffee-bistro/partnership.css`
- 📄 `template-parts/project-pillar/g-cup-coffee-bistro/related.css`
- 📄 `template-parts/project-pillar/g-cup-coffee-bistro/specs.css`
