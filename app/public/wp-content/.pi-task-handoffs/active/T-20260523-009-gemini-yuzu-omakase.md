...
# 📋 T-20260523-009 | gemini | yuzu-omakase — Hồ Sơ Thiết Kế Độc Bản / Bespoke Task Specification
...
|---|---|---|
| `id` | `T-20260523-009` | 🆔 Định danh duy nhất của task con. |
...
Mục tiêu tối thượng là nâng cấp visual cho dự án **Yuzu Omakase Sushi** thoát khỏi sự rập khuôn phẳng lì Elementor cũ, mang lại trải nghiệm thị giác độc bản theo đúng nhóm thiết kế nghệ thuật **Organic Wabi-Sabi (Yuzu Minimalist Zen)**.

### 🌟 Ý tưởng độc bản:
- **Định vị cốt lõi**: Asymmetric Citrus Void - Tông vàng nhạt sương mai phối đá xám thô và gỗ tuyết tùng sáng màu của Nhật Bản. Khung ảnh dạng bầu tròn tự nhiên tựa lát quả Yuzu cắt ngang, các văn bản tối giản ẩn hiện giữa những khoảng trống rộng mở đầy triết lý thiền định.
- **Intro & Concept**: Intro sử dụng layout Zen cực kỳ tinh khiết, khoảng lặng rộng lớn tôn vinh quả Yuzu tươi. Concept dùng Offset Frame gỗ tuyết tùng bao lấy ảnh lát cá hồi tươi.
...
- 📄 `template-parts/project-pillar/yuzu-omakase/concept.php`
- 📄 `template-parts/project-pillar/yuzu-omakase/cta.php`
- 📄 `template-parts/project-pillar/yuzu-omakase/gallery.php`
- 📄 `template-parts/project-pillar/yuzu-omakase/hero.php`
- 📄 `template-parts/project-pillar/yuzu-omakase/intro.php`
- 📄 `template-parts/project-pillar/yuzu-omakase/partnership.php`
- 📄 `template-parts/project-pillar/yuzu-omakase/related.php`
- 📄 `template-parts/project-pillar/yuzu-omakase/specs.php`
- 📄 `template-parts/project-pillar/yuzu-omakase/concept.css`
- 📄 `template-parts/project-pillar/yuzu-omakase/cta.css`
- 📄 `template-parts/project-pillar/yuzu-omakase/gallery.css`
- 📄 `template-parts/project-pillar/yuzu-omakase/hero.css`
- 📄 `template-parts/project-pillar/yuzu-omakase/intro.css`
- 📄 `template-parts/project-pillar/yuzu-omakase/partnership.css`
- 📄 `template-parts/project-pillar/yuzu-omakase/related.css`
- 📄 `template-parts/project-pillar/yuzu-omakase/specs.css`
