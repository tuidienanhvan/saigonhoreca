...
<main id="primary" class="sh-archive" tabindex="-1">
    <!-- Hero Section -->
    <section class="sh-archive__hero category-hero-bg">
        <div class="sh-archive__hero-inner">
            ...
            <p class="sh-archive__count">
                ...
                printf(_n('Có tổng cộng <strong>%d</strong> bài viết', 'Có tổng cộng <strong>%d</strong> bài viết', $total, 'saigonhoreca'), $total);
                ?>
            </p>
        </div>
