...
<section class="pp-hero">
    <div class="pp-hero__media" style="background-image:url('<?php echo sgh_img('2025/11/hemma-desserts-3.jpg'); ?>'); background-size:cover; background-position:center;"></div>
