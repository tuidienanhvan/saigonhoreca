...
<section class="pp__section pp__section--alt">
  <div class="pp__container">
    <div class="pp-split-shf pp-split-shf--reverse">
      <div class="pp-split-shf__body">
        <span class="pp-text-shf__divider" aria-hidden="true"></span>
        <h2 class="pp-text-shf__title"><?php echo esc_html__('Điểm nhấn mạnh mẽ trong thiết kế của Saigon Horeca', 'saigonhoreca'); ?></h2>
