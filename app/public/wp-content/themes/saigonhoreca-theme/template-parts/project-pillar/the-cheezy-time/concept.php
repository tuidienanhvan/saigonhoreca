...
?>
<section class="pp-section-bg-tct" style="background-image:url('<?php echo sgh_img('2026/03/du-an-thecheezytime.jpg'); ?>');">
  <div class="pp-section-bg-tct__overlay" aria-hidden="true"></div>
  <div class="pp-section-bg-tct__content">
    <span class="pp-text-tct__divider pp-text-tct__divider--center" aria-hidden="true"></span>
    <h2 class="pp-text-tct__title"><?php echo esc_html__('Khi concept có chiều sâu, căn bếp không thể là phần phụ', 'saigonhoreca'); ?></h2>
