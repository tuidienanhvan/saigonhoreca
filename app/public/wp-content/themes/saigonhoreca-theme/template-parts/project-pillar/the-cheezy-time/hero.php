...
<section class="pp-hero-tct">
    <div class="pp-hero-tct__media" style="background-image:url('<?php echo sgh_img('the-cheezy-time/the-cheezy-time-hero.jpg'); ?>'); background-size:cover; background-position:center;"></div>
