...
<section class="pp__section pp__section--alt">
  <div class="pp__container">
    <div class="pp-text pp-text--center">
      ...
      <h2 class="pp-text__title"><?php echo esc_html__('Không gian G-Cup Bistro – Khi thiết kế và vận hành song hành trong từng chi tiết', 'saigonhoreca'); ?></h2>
    ...
    <div class="pp-gallery pp-gallery--cols-2" style="margin-top:2rem;">
      <div class="pp-gallery__item"><img src="<?php echo sgh_img('2025/05/du-an-g-cup-coffee-bistro-7.jpg'); ?>" alt="<?php echo esc_attr__('Thiết bị bếp công nghiệp Saigon Horeca', 'saigonhoreca'); ?>" loading="lazy" decoding="async" width="1366" height="768"></div>
      <div class="pp-gallery__item"><img src="<?php echo sgh_img('2025/05/du-an-g-cup-coffee-bistro-16.jpg'); ?>" alt="<?php echo esc_attr__('Thiết bị bếp công nghiệp Saigon Horeca', 'saigonhoreca'); ?>" loading="lazy" decoding="async" width="1366" height="768"></div>
    </div>
  </div>
</section>
