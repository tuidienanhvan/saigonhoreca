...
<section class="pp-hero">
    ...
    <div class="pp-hero__content">
        <h1 class="pp-hero__title">Dự Nam An An</h1>
        <p class="pp-hero__subhead"><?php echo esc_html__('Khi gian bếp trở thành nền tảng của sự chăm sóc tinh tế', 'saigonhoreca'); ?></p>
    </div>
</section>
