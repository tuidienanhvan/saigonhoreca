...
<section class="pp-hero">
    ...
    <div class="pp-hero__content">
        <h1 class="pp-hero__title"><?php echo esc_html__('Casa Maria', 'saigonhoreca'); ?></h1>
        <p class="pp-hero__subhead"><?php echo esc_html__('Khi không gian Tapas & Wine cần một căn bếp "biết kể chuyện"', 'saigonhoreca'); ?></p>
    </div>
</section>
