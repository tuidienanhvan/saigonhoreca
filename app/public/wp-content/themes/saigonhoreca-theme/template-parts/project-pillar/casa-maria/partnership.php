...
<section class="pp__section pp__section--alt">
  <div class="pp__container">
    <div class="pp-split-cma pp-split-cma--reverse">
      <div class="pp-split-cma__body">
        <span class="pp-text-cma__divider" aria-hidden="true"></span>
        <h2 class="pp-text-cma__title"><?php echo esc_html__('Giải pháp bảo quản – Trữ đông – Chuẩn mực cho nguyên liệu Âu', 'saigonhoreca'); ?></h2>
