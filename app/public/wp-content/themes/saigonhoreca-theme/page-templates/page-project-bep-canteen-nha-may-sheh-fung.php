<?php
/**
 * Template Name: Project — SHEH FUNG
 *
...
<main id="primary" class="pp" tabindex="-1">
    ...
    get_template_part('template-parts/project-pillar/bep-canteen-nha-may-sheh-fung/related');
    get_template_part('template-parts/project-pillar/bep-canteen-nha-may-sheh-fung/cta');
