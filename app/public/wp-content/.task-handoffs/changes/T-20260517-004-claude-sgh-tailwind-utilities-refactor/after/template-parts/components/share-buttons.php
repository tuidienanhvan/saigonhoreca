...
<div class="sh-share" data-aos="fade-up">
    <div class="sh-share__inner">
        ...
        <button data-share-action="copy" data-share-url="<?php echo esc_attr($permalink); ?>" class="sh-share__btn sh-share__btn--copy sh-copy-btn" aria-label="Sao chép liên kết">
