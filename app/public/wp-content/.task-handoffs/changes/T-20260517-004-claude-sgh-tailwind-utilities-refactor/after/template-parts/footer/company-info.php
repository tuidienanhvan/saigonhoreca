...
$logo_url = $args['logo_url'] ?? get_template_directory_uri() . '/assets/images/logo.webp?v=3';
?>
<div class="sh-footer__company" data-aos="fade-up">
    ...
    <p class="sh-footer__company-desc"><?php echo esc_html($contact['company_full'] ?? ''); ?></p>
