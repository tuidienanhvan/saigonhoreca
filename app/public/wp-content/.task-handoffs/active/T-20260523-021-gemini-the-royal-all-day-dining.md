...
# 📋 T-20260523-021 | gemini | the-royal-all-day-dining — Hồ Sơ Thiết Kế Độc Bản / Bespoke Task Specification
...
|---|---|---|
| `id` | `T-20260523-021` | 🆔 Định danh duy nhất của task con. |
...
Mục tiêu tối thượng là nâng cấp visual cho dự án **The Royal All Day Dining** thoát khỏi sự rập khuôn phẳng lì Elementor cũ, mang lại trải nghiệm thị giác độc bản theo đúng nhóm thiết kế nghệ thuật **European Elegance (Victorian Regal)**.

### 🌟 Ý tưởng độc bản:
- **Định vị cốt lõi**: Victorian Regal Grid - Tông xanh navy hoàng gia và chỉ vàng kim sắc mảnh, font chữ Serif cực kỳ nghiêm cẩn quý phái chuẩn London. Các block thông tin được bao bọc bởi khung viền chỉ mỏng trang nhã tựa như các tấm menu tiệc trà chiều hoàng gia.
- **Intro & Concept**: Intro sử dụng layout đối xứng hoàn mỹ của kiến trúc cổ điển Anh Quốc. Concept dùng card kính màu navy viền chỉ vàng kim siêu thanh lịch.
...
- 📄 `template-parts/project-pillar/the-royal-all-day-dining/concept.php`
- 📄 `template-parts/project-pillar/the-royal-all-day-dining/cta.php`
- 📄 `template-parts/project-pillar/the-royal-all-day-dining/gallery.php`
- 📄 `template-parts/project-pillar/the-royal-all-day-dining/hero.php`
- 📄 `template-parts/project-pillar/the-royal-all-day-dining/intro.php`
- 📄 `template-parts/project-pillar/the-royal-all-day-dining/partnership.php`
- 📄 `template-parts/project-pillar/the-royal-all-day-dining/related.php`
- 📄 `template-parts/project-pillar/the-royal-all-day-dining/specs.php`
- 📄 `template-parts/project-pillar/the-royal-all-day-dining/concept.css`
- 📄 `template-parts/project-pillar/the-royal-all-day-dining/cta.css`
- 📄 `template-parts/project-pillar/the-royal-all-day-dining/gallery.css`
- 📄 `template-parts/project-pillar/the-royal-all-day-dining/hero.css`
- 📄 `template-parts/project-pillar/the-royal-all-day-dining/intro.css`
- 📄 `template-parts/project-pillar/the-royal-all-day-dining/partnership.css`
- 📄 `template-parts/project-pillar/the-royal-all-day-dining/related.css`
- 📄 `template-parts/project-pillar/the-royal-all-day-dining/specs.css`
