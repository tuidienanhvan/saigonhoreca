...
# 📋 T-20260523-008 | gemini | mam-mam-eatery-lounge-nang-tam-mam-com-viet — Hồ Sơ Thiết Kế Độc Bản / Bespoke Task Specification
...
|---|---|---|
| `id` | `T-20260523-008` | 🆔 Định danh duy nhất của task con. |
...
Mục tiêu tối thượng là nâng cấp visual cho dự án **Măm Măm Eatery Lounge** thoát khỏi sự rập khuôn phẳng lì Elementor cũ, mang lại trải nghiệm thị giác độc bản theo đúng nhóm thiết kế nghệ thuật **Cyberpunk Glow (Neo-Vietnamese Cyberpunk)**.

### 🌟 Ý tưởng độc bản:
- **Định vị cốt lõi**: Neon Lantern Panel - Sự kết hợp giữa nền tối hiện đại và các dải viền sáng màu cam ấm của đèn lồng Hội An kết hợp đỏ ớt đương đại. Khung ảnh thiết kế theo cấu trúc ô cửa sổ tre cách tân sang trọng chấn cơ khí góc cạnh.
- **Intro & Concept**: Intro mang không khí ấm cúng nhưng thời thượng của lounge Việt đương đại. Concept sử dụng 3 bảng lưới dọc song song xếp lệch tầng.
...
- 📄 `template-parts/project-pillar/mam-mam-eatery-lounge-nang-tam-mam-com-viet/concept.php`
- 📄 `template-parts/project-pillar/mam-mam-eatery-lounge-nang-tam-mam-com-viet/cta.php`
- 📄 `template-parts/project-pillar/mam-mam-eatery-lounge-nang-tam-mam-com-viet/gallery.php`
- 📄 `template-parts/project-pillar/mam-mam-eatery-lounge-nang-tam-mam-com-viet/hero.php`
- 📄 `template-parts/project-pillar/mam-mam-eatery-lounge-nang-tam-mam-com-viet/intro.php`
- 📄 `template-parts/project-pillar/mam-mam-eatery-lounge-nang-tam-mam-com-viet/partnership.php`
- 📄 `template-parts/project-pillar/mam-mam-eatery-lounge-nang-tam-mam-com-viet/related.php`
- 📄 `template-parts/project-pillar/mam-mam-eatery-lounge-nang-tam-mam-com-viet/specs.php`
- 📄 `template-parts/project-pillar/mam-mam-eatery-lounge-nang-tam-mam-com-viet/concept.css`
- 📄 `template-parts/project-pillar/mam-mam-eatery-lounge-nang-tam-mam-com-viet/cta.css`
- 📄 `template-parts/project-pillar/mam-mam-eatery-lounge-nang-tam-mam-com-viet/gallery.css`
- 📄 `template-parts/project-pillar/mam-mam-eatery-lounge-nang-tam-mam-com-viet/hero.css`
- 📄 `template-parts/project-pillar/mam-mam-eatery-lounge-nang-tam-mam-com-viet/intro.css`
- 📄 `template-parts/project-pillar/mam-mam-eatery-lounge-nang-tam-mam-com-viet/partnership.css`
- 📄 `template-parts/project-pillar/mam-mam-eatery-lounge-nang-tam-mam-com-viet/related.css`
- 📄 `template-parts/project-pillar/mam-mam-eatery-lounge-nang-tam-mam-com-viet/specs.css`
