...
# 📋 T-20260523-024 | gemini | spice-world-hotpot — Hồ Sơ Thiết Kế Độc Bản / Bespoke Task Specification
...
|---|---|---|
| `id` | `T-20260523-024` | 🆔 Định danh duy nhất của task con. |
...
Mục tiêu tối thượng là nâng cấp visual cho dự án **Spice World Hotpot** thoát khỏi sự rập khuôn phẳng lì Elementor cũ, mang lại trải nghiệm thị giác độc bản theo đúng nhóm thiết kế nghệ thuật **Michelin Heritage (Sichuan Dragon Heritage)**.

### 🌟 Ý tưởng độc bản:
- **Định vị cốt lõi**: Crimson Dragon Blueprint - Tông đỏ trầm hoàng gia kết hợp vàng hoàng thổ, sử dụng các đường nét hoa văn cửa sổ gỗ Trung Hoa cổ kết cấu cơ khí hiện đại. Bố cục lưới phác thảo nồi nước lẩu cay nồng 9 ô đặc trưng, dropcap chữ S cách điệu rồng cuộn.
- **Intro & Concept**: Intro mang không khí hoành tráng của tửu lâu Thành Đô cổ kính qua bản vẽ kỹ thuật nồi lẩu inox. Concept chia 3 cột lệch lồng khung gỗ gốm.
...
- 📄 `template-parts/project-pillar/spice-world-hotpot/02-with_gallery.php`
- 📄 `template-parts/project-pillar/spice-world-hotpot/03-split.php`
- 📄 `template-parts/project-pillar/spice-world-hotpot/04-bg_section.php`
- 📄 `template-parts/project-pillar/spice-world-hotpot/05-split.php`
- 📄 `template-parts/project-pillar/spice-world-hotpot/06-split.php`
- 📄 `template-parts/project-pillar/spice-world-hotpot/07-split.php`
- 📄 `template-parts/project-pillar/spice-world-hotpot/concept.php`
- 📄 `template-parts/project-pillar/spice-world-hotpot/cta.php`
- 📄 `template-parts/project-pillar/spice-world-hotpot/gallery.php`
- 📄 `template-parts/project-pillar/spice-world-hotpot/hero.php`
- 📄 `template-parts/project-pillar/spice-world-hotpot/intro.php`
- 📄 `template-parts/project-pillar/spice-world-hotpot/partnership.php`
- 📄 `template-parts/project-pillar/spice-world-hotpot/related.php`
- 📄 `template-parts/project-pillar/spice-world-hotpot/specs.php`
- 📄 `template-parts/project-pillar/spice-world-hotpot/concept.css`
- 📄 `template-parts/project-pillar/spice-world-hotpot/cta.css`
- 📄 `template-parts/project-pillar/spice-world-hotpot/gallery.css`
- 📄 `template-parts/project-pillar/spice-world-hotpot/hero.css`
- 📄 `template-parts/project-pillar/spice-world-hotpot/intro.css`
- 📄 `template-parts/project-pillar/spice-world-hotpot/partnership.css`
- 📄 `template-parts/project-pillar/spice-world-hotpot/related.css`
- 📄 `template-parts/project-pillar/spice-world-hotpot/specs.css`
