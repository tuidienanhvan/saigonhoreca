...
# 📋 T-20260523-029 | gemini | du-an-vinh-hiep — Hồ Sơ Thiết Kế Độc Bản / Bespoke Task Specification
...
|---|---|---|
| `id` | `T-20260523-029` | 🆔 Định danh duy nhất của task con. |
...
Mục tiêu tối thượng là nâng cấp visual cho dự án **Nhà Máy Cà Phê Xuất Khẩu Vinh Hiệp** thoát khỏi sự rập khuôn phẳng lì Elementor cũ, mang lại trải nghiệm thị giác độc bản theo đúng nhóm thiết kế nghệ thuật **Industrial Coffee Factory Spec (Công Nghệ Cao)**.

### 🌟 Ý tưởng độc bản:
- **Định vị cốt lõi**: Coffee Roastery Spec - Thiết kế mang màu sắc của hạt cà phê rang mộc kết hợp inox công nghiệp hiện đại. Các đường line phân chia kỹ thuật màu nâu espresso sang trọng, bố cục chia cột bất đối xứng mô phỏng quy trình khép kín từ nông trại đến tách cà phê sạch.
- **Intro & Concept**: Bố cục specs trình bày dạng dây chuyền sản xuất tự động hóa. Concept sử dụng các khung ảnh góc cạnh vững chãi.
...
- 📄 `template-parts/project-pillar/du-an-vinh-hiep/01-hero.php`
- 📄 `template-parts/project-pillar/du-an-vinh-hiep/02-with_gallery.php`
- 📄 `template-parts/project-pillar/du-an-vinh-hiep/03-split.php`
- 📄 `template-parts/project-pillar/du-an-vinh-hiep/04-split.php`
- 📄 `template-parts/project-pillar/du-an-vinh-hiep/05-with_gallery.php`
- 📄 `template-parts/project-pillar/du-an-vinh-hiep/concept.php`
- 📄 `template-parts/project-pillar/du-an-vinh-hiep/cta.php`
- 📄 `template-parts/project-pillar/du-an-vinh-hiep/gallery.php`
- 📄 `template-parts/project-pillar/du-an-vinh-hiep/hero.php`
- 📄 `template-parts/project-pillar/du-an-vinh-hiep/intro.php`
- 📄 `template-parts/project-pillar/du-an-vinh-hiep/partnership.php`
- 📄 `template-parts/project-pillar/du-an-vinh-hiep/related.php`
- 📄 `template-parts/project-pillar/du-an-vinh-hiep/specs.php`
- 📄 `template-parts/project-pillar/du-an-vinh-hiep/concept.css`
- 📄 `template-parts/project-pillar/du-an-vinh-hiep/cta.css`
- 📄 `template-parts/project-pillar/du-an-vinh-hiep/gallery.css`
- 📄 `template-parts/project-pillar/du-an-vinh-hiep/hero.css`
- 📄 `template-parts/project-pillar/du-an-vinh-hiep/intro.css`
- 📄 `template-parts/project-pillar/du-an-vinh-hiep/partnership.css`
- 📄 `template-parts/project-pillar/du-an-vinh-hiep/related.css`
- 📄 `template-parts/project-pillar/du-an-vinh-hiep/specs.css`
