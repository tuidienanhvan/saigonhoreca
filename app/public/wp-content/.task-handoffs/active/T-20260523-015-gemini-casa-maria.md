...
# 📋 T-20260523-015 | gemini | casa-maria — Hồ Sơ Thiết Kế Độc Bản / Bespoke Task Specification
...
|---|---|---|
| `id` | `T-20260523-015` | 🆔 Định danh duy nhất của task con. |
...
Mục tiêu tối thượng là nâng cấp visual cho dự án **Casa Maria Restaurant** thoát khỏi sự rập khuôn phẳng lì Elementor cũ, mang lại trải nghiệm thị giác độc bản theo đúng nhóm thiết kế nghệ thuật **European Elegance (Italian Warmth)**.

### 🌟 Ý tưởng độc bản:
- **Định vị cốt lõi**: Tuscan Sun Editorial Grid - Tông màu kem terracotta ấm áp, sử dụng các khung ảnh so le đan xen kiểu tạp chí ẩm thực Địa Trung Hải. Dropcap chữ C cách điệu nét cong mềm mại như cổng vòm đất nung kiểu Ý cổ kính.
- **Intro & Concept**: Intro sử dụng layout 3 cột không đối xứng mô phỏng trang sách cổ. Concept sử dụng các tấm ảnh có viền khung đất nung mộc mạc.
...
- 📄 `template-parts/project-pillar/casa-maria/01-hero.php`
- 📄 `template-parts/project-pillar/casa-maria/02-with_gallery.php`
- 📄 `template-parts/project-pillar/casa-maria/03-split.php`
- 📄 `template-parts/project-pillar/casa-maria/04-split.php`
- 📄 `template-parts/project-pillar/casa-maria/05-with_gallery.php`
- 📄 `template-parts/project-pillar/casa-maria/concept.php`
- 📄 `template-parts/project-pillar/casa-maria/cta.php`
- 📄 `template-parts/project-pillar/casa-maria/gallery.php`
- 📄 `template-parts/project-pillar/casa-maria/hero.php`
- 📄 `template-parts/project-pillar/casa-maria/intro.php`
- 📄 `template-parts/project-pillar/casa-maria/partnership.php`
- 📄 `template-parts/project-pillar/casa-maria/related.php`
- 📄 `template-parts/project-pillar/casa-maria/specs.php`
- 📄 `template-parts/project-pillar/casa-maria/concept.css`
- 📄 `template-parts/project-pillar/casa-maria/cta.css`
- 📄 `template-parts/project-pillar/casa-maria/gallery.css`
- 📄 `template-parts/project-pillar/casa-maria/hero.css`
- 📄 `template-parts/project-pillar/casa-maria/intro.css`
- 📄 `template-parts/project-pillar/casa-maria/partnership.css`
- 📄 `template-parts/project-pillar/casa-maria/related.css`
- 📄 `template-parts/project-pillar/casa-maria/specs.css`
