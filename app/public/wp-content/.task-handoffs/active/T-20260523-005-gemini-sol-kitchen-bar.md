...
# 📋 T-20260523-005 | gemini | sol-kitchen-bar — Hồ Sơ Thiết Kế Độc Bản / Bespoke Task Specification
...
|---|---|---|
| `id` | `T-20260523-005` | 🆔 Định danh duy nhất của task con. |
...
Mục tiêu tối thượng là nâng cấp visual cho dự án **Sol Kitchen & Bar District 1** thoát khỏi sự rập khuôn phẳng lì Elementor cũ, mang lại trải nghiệm thị giác độc bản theo đúng nhóm thiết kế nghệ thuật **Cyberpunk Neon Glow (Latin Tropical Cyber)**.

### 🌟 Ý tưởng độc bản:
- **Định vị cốt lõi**: Neon Tropical Grid - Viền neon màu đỏ gạch nung nồng ấm và vàng nắng Địa Trung Hải rực rỡ đan chéo góc chấn kim loại, card trích dẫn glassmorphic trong veo hiện rõ ảnh bếp mở nướng lò than ngoài trời cực kỳ phóng khoáng.
- **Intro & Concept**: Intro sử dụng layout 2 cột bất đối xứng mạnh mẽ của vùng Nam Mỹ nhiệt đới. Concept là lưới 4 ô vuông vức rực lửa neon ấm.
...
- 📄 `template-parts/project-pillar/sol-kitchen-bar/concept.php`
- 📄 `template-parts/project-pillar/sol-kitchen-bar/cta.php`
- 📄 `template-parts/project-pillar/sol-kitchen-bar/gallery.php`
- 📄 `template-parts/project-pillar/sol-kitchen-bar/hero.php`
- 📄 `template-parts/project-pillar/sol-kitchen-bar/intro.php`
- 📄 `template-parts/project-pillar/sol-kitchen-bar/partnership.php`
- 📄 `template-parts/project-pillar/sol-kitchen-bar/related.php`
- 📄 `template-parts/project-pillar/sol-kitchen-bar/specs.php`
- 📄 `template-parts/project-pillar/sol-kitchen-bar/concept.css`
- 📄 `template-parts/project-pillar/sol-kitchen-bar/cta.css`
- 📄 `template-parts/project-pillar/sol-kitchen-bar/gallery.css`
- 📄 `template-parts/project-pillar/sol-kitchen-bar/hero.css`
- 📄 `template-parts/project-pillar/sol-kitchen-bar/intro.css`
- 📄 `template-parts/project-pillar/sol-kitchen-bar/partnership.css`
- 📄 `template-parts/project-pillar/sol-kitchen-bar/related.css`
- 📄 `template-parts/project-pillar/sol-kitchen-bar/specs.css`
