...
# 📋 T-20260523-027 | gemini | du-an-bep-cang-tin-cong-ty-nhat-nichiyo — Hồ Sơ Thiết Kế Độc Bản / Bespoke Task Specification
...
|---|---|---|
| `id` | `T-20260523-027` | 🆔 Định danh duy nhất của task con. |
...
Mục tiêu tối thượng là nâng cấp visual cho dự án **Bếp Căng Tin Công Ty Nhật Nichiyo** thoát khỏi sự rập khuôn phẳng lì Elementor cũ, mang lại trải nghiệm thị giác độc bản theo đúng nhóm thiết kế nghệ thuật **Zen Industrial Spec (Tối Giản Nhật Bản)**.

### 🌟 Ý tưởng độc bản:
- **Định vị cốt lõi**: Japanese Precision Layout - Kết hợp thép không gỉ sáng loáng và gỗ sồi sáng tối giản của Nhật Bản. Lưới thông số kỹ thuật mỏng nhẹ sắc sảo như bản vẽ kỹ thuật kiến trúc tối giản của Nhật, có khung viền gỗ mộc bao quanh ảnh Inox.
- **Intro & Concept**: Layout cực kỳ ngăn nắp, khoảng trắng Zen Void rộng mở làm nổi bật các chi tiết thiết bị bếp. Intro sử dụng font chữ không chân hiện đại.
...
- 📄 `template-parts/project-pillar/du-an-bep-cang-tin-cong-ty-nhat-nichiyo/concept.php`
- 📄 `template-parts/project-pillar/du-an-bep-cang-tin-cong-ty-nhat-nichiyo/cta.php`
- 📄 `template-parts/project-pillar/du-an-bep-cang-tin-cong-ty-nhat-nichiyo/gallery.php`
- 📄 `template-parts/project-pillar/du-an-bep-cang-tin-cong-ty-nhat-nichiyo/hero.php`
- 📄 `template-parts/project-pillar/du-an-bep-cang-tin-cong-ty-nhat-nichiyo/intro.php`
- 📄 `template-parts/project-pillar/du-an-bep-cang-tin-cong-ty-nhat-nichiyo/partnership.php`
- 📄 `template-parts/project-pillar/du-an-bep-cang-tin-cong-ty-nhat-nichiyo/related.php`
- 📄 `template-parts/project-pillar/du-an-bep-cang-tin-cong-ty-nhat-nichiyo/specs.php`
- 📄 `template-parts/project-pillar/du-an-bep-cang-tin-cong-ty-nhat-nichiyo/concept.css`
- 📄 `template-parts/project-pillar/du-an-bep-cang-tin-cong-ty-nhat-nichiyo/cta.css`
- 📄 `template-parts/project-pillar/du-an-bep-cang-tin-cong-ty-nhat-nichiyo/gallery.css`
- 📄 `template-parts/project-pillar/du-an-bep-cang-tin-cong-ty-nhat-nichiyo/hero.css`
- 📄 `template-parts/project-pillar/du-an-bep-cang-tin-cong-ty-nhat-nichiyo/intro.css`
- 📄 `template-parts/project-pillar/du-an-bep-cang-tin-cong-ty-nhat-nichiyo/partnership.css`
- 📄 `template-parts/project-pillar/du-an-bep-cang-tin-cong-ty-nhat-nichiyo/related.css`
- 📄 `template-parts/project-pillar/du-an-bep-cang-tin-cong-ty-nhat-nichiyo/specs.css`
