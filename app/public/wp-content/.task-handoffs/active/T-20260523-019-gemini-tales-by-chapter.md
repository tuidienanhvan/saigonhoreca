...
# 📋 T-20260523-019 | gemini | tales-by-chapter — Hồ Sơ Thiết Kế Độc Bản / Bespoke Task Specification
...
|---|---|---|
| `id` | `T-20260523-019` | 🆔 Định danh duy nhất của task con. |
...
Mục tiêu tối thượng là nâng cấp visual cho dự án **Tales by Chapter Restaurant** thoát khỏi sự rập khuôn phẳng lì Elementor cũ, mang lại trải nghiệm thị giác độc bản theo đúng nhóm thiết kế nghệ thuật **European Elegance (Cinematic Film Noir)**.

### 🌟 Ý tưởng độc bản:
- **Định vị cốt lõi**: Film Noir Editorial - Bố cục như một trang kịch bản phim cổ điển châu Âu, tông xám bạc sang trọng kết hợp đen mun huyền bí. Các khung ảnh kiểu ống kính Cinemascope tỉ lệ rộng 2.39:1, các block chữ Serif được sắp đặt tựa như các phân đoạn tiểu thuyết lãng mạn.
- **Intro & Concept**: Intro sử dụng layout tựa như một thước phim điện ảnh tua chậm với góc quay rộng. Concept sử dụng 2 cột chữ nghiêng kiểu kịch bản sân khấu.
...
- 📄 `template-parts/project-pillar/tales-by-chapter/01-hero.php`
- 📄 `template-parts/project-pillar/tales-by-chapter/02-with_gallery.php`
- 📄 `template-parts/project-pillar/tales-by-chapter/03-split.php`
- 📄 `template-parts/project-pillar/tales-by-chapter/04-split.php`
- 📄 `template-parts/project-pillar/tales-by-chapter/05-text.php`
- 📄 `template-parts/project-pillar/tales-by-chapter/concept.php`
- 📄 `template-parts/project-pillar/tales-by-chapter/cta.php`
- 📄 `template-parts/project-pillar/tales-by-chapter/gallery.php`
- 📄 `template-parts/project-pillar/tales-by-chapter/hero.php`
- 📄 `template-parts/project-pillar/tales-by-chapter/intro.php`
- 📄 `template-parts/project-pillar/tales-by-chapter/partnership.php`
- 📄 `template-parts/project-pillar/tales-by-chapter/related.php`
- 📄 `template-parts/project-pillar/tales-by-chapter/specs.php`
- 📄 `template-parts/project-pillar/tales-by-chapter/concept.css`
- 📄 `template-parts/project-pillar/tales-by-chapter/cta.css`
- 📄 `template-parts/project-pillar/tales-by-chapter/gallery.css`
- 📄 `template-parts/project-pillar/tales-by-chapter/hero.css`
- 📄 `template-parts/project-pillar/tales-by-chapter/intro.css`
- 📄 `template-parts/project-pillar/tales-by-chapter/partnership.css`
- 📄 `template-parts/project-pillar/tales-by-chapter/related.css`
- 📄 `template-parts/project-pillar/tales-by-chapter/specs.css`
