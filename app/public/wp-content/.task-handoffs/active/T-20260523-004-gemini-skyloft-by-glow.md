...
# 📋 T-20260523-004 | gemini | skyloft-by-glow — Hồ Sơ Thiết Kế Độc Bản / Bespoke Task Specification
...
|---|---|---|
| `id` | `T-20260523-004` | 🆔 Định danh duy nhất của task con. |
...
Mục tiêu tối thượng là nâng cấp visual cho dự án **Skyloft by Glow** thoát khỏi sự rập khuôn phẳng lì Elementor cũ, mang lại trải nghiệm thị giác độc bản theo đúng nhóm thiết kế nghệ thuật **Cyberpunk Neon Glow (Skyline Bar)**.

### 🌟 Ý tưởng độc bản:
- **Định vị cốt lõi**: Floating Sky Panels - Sử dụng tông màu xanh dương ban đêm sâu thẳm kết hợp viền neon xanh neon sặc sỡ lơ lửng giữa trời cao. Khung ảnh có hiệu ứng đổ bóng mờ cực lớn như đang bay bổng trên nền trời đêm Sài Gòn rực rỡ ánh đèn.
- **Intro & Concept**: Intro sử dụng layout lưới các tấm panel nghiêng nhẹ 3D lơ lửng. Concept mang hơi thở hiện đại phóng khoáng của bar sân thượng.
...
- 📄 `template-parts/project-pillar/skyloft-by-glow/concept.php`
- 📄 `template-parts/project-pillar/skyloft-by-glow/cta.php`
- 📄 `template-parts/project-pillar/skyloft-by-glow/gallery.php`
- 📄 `template-parts/project-pillar/skyloft-by-glow/hero.php`
- 📄 `template-parts/project-pillar/skyloft-by-glow/intro.php`
- 📄 `template-parts/project-pillar/skyloft-by-glow/partnership.php`
- 📄 `template-parts/project-pillar/skyloft-by-glow/related.php`
- 📄 `template-parts/project-pillar/skyloft-by-glow/specs.php`
- 📄 `template-parts/project-pillar/skyloft-by-glow/concept.css`
- 📄 `template-parts/project-pillar/skyloft-by-glow/cta.css`
- 📄 `template-parts/project-pillar/skyloft-by-glow/gallery.css`
- 📄 `template-parts/project-pillar/skyloft-by-glow/hero.css`
- 📄 `template-parts/project-pillar/skyloft-by-glow/intro.css`
- 📄 `template-parts/project-pillar/skyloft-by-glow/partnership.css`
- 📄 `template-parts/project-pillar/skyloft-by-glow/related.css`
- 📄 `template-parts/project-pillar/skyloft-by-glow/specs.css`
